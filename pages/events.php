    ...
    <div class="col-md-12 mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <img src="data:image/jpeg;base64,<?php echo base64_encode($row['eventIMG']); ?>" class="card-img-top" alt="Event Photo" data-toggle="modal" data-target="#imgModal<?php echo $row['id']; ?>" data-caption="<?php echo htmlspecialchars($row['caption'], ENT_QUOTES); ?>" data-description="<?php echo htmlspecialchars($row['deskripsi'], ENT_QUOTES); ?>">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    imgCardButtons.forEach((button) => {
        button.addEventListener("click", function () {
            ...
            modalCaption.textContent = button.getAttribute("data-description");
        });
    });
});
</script>
